...
import { useFeachUserQuery } from "./api";
...
//  );
 ...
 const userDataSlice = createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        builder.addCase(useFeachUserQuery.fulfilled,(state,action)=>{
        ...
        builder.addCase(useFeachUserQuery.pending,(state,action)=>{
            state.statusState = 'pending';
            state.errorState = null
        });
        builder.addCase(useFeachUserQuery.rejected,(state,action)=>{
            state.statusState = 'rejected';
